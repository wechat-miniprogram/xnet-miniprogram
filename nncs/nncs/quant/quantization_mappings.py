...
import nncs.nn.intrinsic.quantized as nniq
import nncs.nn.intrinsic.qat as nniqat
import nncs.nn.qat as nnqat
import nncs.nn.intrinsic.qat.lm as nniqatlm
from nncs.quant.stubs import QuantStub, DeQuantStub
from nncs.fake_quantize.fake_quantize_base import (
...
DEFAULT_QAT_MODULE_MAPPINGS: Dict[Callable, Any] = {
    ...
    nn.ConvTranspose2d: nnqat.ConvTranspose2d,
    # Intrinsic modules:
    ...
    nni.ConvBnReLU62d: nniqat.ConvBnReLU62d,
    nni.ConvReLU62d: nniqat.ConvReLU62d,
    nni.LinearReLU6: nniqat.LinearReLU6,
    nni.ConvTransposeReLU2d: nniqat.ConvTransposeReLU2d,
    nni.ConvTransposeReLU62d: nniqat.ConvTransposeReLU62d,
    nni.ConvTransposeBn2d: nniqat.ConvTransposeBn2d,
    nni.ConvTransposeBnReLU2d: nniqat.ConvTransposeBnReLU2d,
    nni.ConvTransposeBnReLU62d: nniqat.ConvTransposeBnReLU62d,
    nni.ConvBnLearnableClip82d: nniqat.ConvBnLearnableClip82d,
    nni.ConvLearnableClip82d: nniqat.ConvLearnableClip82d,
}

# Default map for swapping float module to qat modules
CUSTOM_QAT_MODULE_MAPPINGS: Dict[Callable, Any] = {
    nn.Conv1d: nnqat.Conv1d,
    nn.Conv2d: nnqat.Conv2d,
    nn.Linear: nnqat.Linear,
    nn.ConvTranspose2d: nnqat.ConvTranspose2d,
    ...
    nni.ConvReLU2d: nniqat.ConvReLU2d,
    nni.LinearReLU: nniqat.LinearReLU,
    nni.ConvReLU62d: nniqatlm.ConvReLU62d,
    nni.LinearReLU6: nniqatlm.LinearReLU6,
    nni.ConvTransposeReLU2d: nniqat.ConvTransposeReLU2d,
    nni.ConvTransposeReLU62d: nniqat.ConvTransposeReLU62d,
    nni.ConvTransposeBn2d: nniqat.ConvTransposeBn2d,
    nni.ConvTransposeBnReLU2d: nniqat.ConvTransposeBnReLU2d,
...
def get_static_quant_module_class(
    ...
    all_mappings = get_combined_dict(
        DEFAULT_STATIC_QUANT_MODULE_MAPPINGS, additional_static_quant_mapping
    )
