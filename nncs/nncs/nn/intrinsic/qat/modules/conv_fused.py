...
from nncs.nn.intrinsic.custom_op import LearnableReLU6, LearnableClip8
...
class ConvBnReLU62d(ConvBn2d):
    _FLOAT_MODULE = nni.ConvBnReLU62d
    ...
    def forward(self, input):
        return F.relu6(ConvBn2d._forward(self, input))
...
class ConvBnLearnableReLU62d(ConvBn2d):
    _FLOAT_MODULE = nni.ConvBnReLU62d
    ...
    def __init__(
        ...
        super(ConvBnLearnableReLU62d, self).__init__(
            in_channels,
            out_channels,
            kernel_size,
            stride,
    ...
    def forward(self, input):
        return self.relu(ConvBn2d._forward(self, input))

    @classmethod
    def from_float(cls, mod):
        return super(ConvBnLearnableReLU62d, cls).from_float(mod)
...
class ConvLearnableReLU62d(nnqat.Conv2d, nni._FusedModule):
    _FLOAT_MODULE = nni.ConvReLU62d
    ...
    def __init__(
        ...
        super(ConvLearnableReLU62d, self).__init__(
            in_channels,
            out_channels,
            kernel_size,
            stride=stride,
...
class ConvLearnableClip82d(nnqat.Conv2d, nni._FusedModule):
    _FLOAT_MODULE = nni.ConvLearnableClip82d
    ...
    def __init__(
        ...
        super(ConvLearnableClip82d, self).__init__(
            in_channels,
            out_channels,
            kernel_size,
            stride,
    ...
    @classmethod
    def from_float(cls, mod):
        qat_convbn = super(ConvLearnableClip82d, cls).from_float(mod)
        qat_convbn.clip8.upper_val.data.copy_(mod[-1].upper_val.data)
        qat_convbn.clip8.lower_val.data.copy_(mod[-1].lower_val.data)
        return qat_convbn


class ConvBnLearnableClip82d(ConvBn2d):
    _FLOAT_MODULE = nni.ConvBnLearnableClip82d
    ...
    def __init__(
        ...
        super(ConvBnLearnableClip82d, self).__init__(
            in_channels,
            out_channels,
            kernel_size,
            stride,
    ...
    def forward(self, input):
        return self.clip8(ConvBn2d._forward(self, input))

    @classmethod
    def from_float(cls, mod):
        qat_convbn = super(ConvBnLearnableClip82d, cls).from_float(mod)
        qat_convbn.clip8.upper_val.data.copy_(mod[-1].upper_val.data)
        qat_convbn.clip8.lower_val.data.copy_(mod[-1].lower_val.data)
        return qat_convbn
