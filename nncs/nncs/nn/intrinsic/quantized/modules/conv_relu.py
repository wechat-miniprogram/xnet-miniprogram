...
import nncs.nn.intrinsic
import nncs.nn.intrinsic.qat
...
class ConvReLU1d(nnq.Conv1d):
    ...
    """
    _FLOAT_MODULE = nncs.nn.intrinsic.ConvReLU1d  # type: ignore[assignment]
    ...
    def from_float(cls, mod):
        if type(mod) == nncs.nn.intrinsic.qat.ConvBnReLU1d:
...
class ConvReLU2d(nnq.Conv2d):
    ...
    """
    _FLOAT_MODULE = nncs.nn.intrinsic.ConvReLU2d  # type: ignore[assignment]
    ...
    @classmethod
    def from_float(cls, mod):
        if type(mod) == nncs.nn.intrinsic.qat.ConvBnReLU2d:
            mod.weight, mod.bias = fuse_conv_bn_weights(
                mod.weight,
                mod.bias,
                mod.bn.running_mean,
...
class ConvReLU3d(nnq.Conv3d):
    ...
    """
    _FLOAT_MODULE = nncs.nn.intrinsic.ConvReLU3d  # type: ignore[assignment]
