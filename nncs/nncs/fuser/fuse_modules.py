...
def _fuse_modules(
    model, modules_to_fuse, fuser_func=fuse_known_modules, fuse_custom_config_dict=None
):
...
def fuse_modules(
    ...
    Args:
        ...
        fuser_func: Function that takes in a list of modules and outputs a list of fused modules
                    ...
                    Defaults to nncs.quantization.fuse_known_modules
    ...
    Examples::
            ...
            >>> fused_m = nncs.fuser.fuse_modules(m, modules_to_fuse)
