...
from torch.quantization.fx.match_utils import is_match
from torch.quantization.fx.graph_module import FusedGraphModule
from torch.quantization.fx.fusion_patterns import *  # noqa: F401,F403
from torch.quantization.fx.quantization_types import Pattern


class Fuser:
    def fuse(
        self, model: GraphModule, fuse_custom_config_dict: Dict[str, Any] = None
    ) -> GraphModule:
        ...
        fusion_patterns = additional_fusion_patterns
        # find fusion
    ...
    def _find_matches(
        self, root: GraphModule, graph: Graph, patterns: Dict[Pattern, Callable]
